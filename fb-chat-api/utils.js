...
module.exports = {
	...
	getMessageReactions: require("./src/getMessageReactions"),
	getPendingMessages: require("./src/getPendingMessages"),
	setApprovalMode: require("./src/setApprovalMode"),
	acceptPendingRequest: require("./src/acceptPendingRequest"),
	getOnlineUsers: require("./src/getOnlineUsers"),
	createEvent: require("./src/createEvent"),
	setThreadJoinability: require("./src/setThreadJoinability"),
	kickFromGroup: require("./src/kickFromGroup"),
	searchMessages: require("./src/searchMessages"),
	getMessageInfo: require("./src/getMessageInfo"),
	reportMessage: require("./src/reportMessage"),
	getActiveStatus: require("./src/getActiveStatus"),
	setActiveStatus: require("./src/setActiveStatus"),
	setTypingStatus: require("./src/setTypingStatus"),
	CustomError,
	isReadableStream,
	get,
	post,
